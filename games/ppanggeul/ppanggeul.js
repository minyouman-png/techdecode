...
const I18N = {
  en: {
    sub: 'SPACE ADVENTURE', start: '▶ Start Game', cont: '▶ Continue', records: '🏆 Records',
    back: '← Back', retry: '🔄 Play Again', menu: 'Menu', nickPh: 'Nickname',
    help: '<b>←→</b> Move · <b>Space/↑</b> Jump (hold = higher) · <b>Shift</b> Run<br>Stomp on aliens to defeat them · get a piggyback ride from <b>Dad</b> for a double jump!<br>☄️ Comet Chili = tap <b>Shift</b> to shoot fireballs · 🐰 Rabbit Charm = hold jump to glide<br><b>ESC</b> Pause · 📱 touch controls on mobile',
    ...
    impErr: "Not a valid PPANGGEUL'S ADVENTURE save file", expDone: 'Save file downloaded',
    ...
    emptyRec: 'No records yet — go find Gwiyomi!',
    pauseT: '⏸ Paused', resume: '▶ Resume', quit: '🏳 Quit',
    quitConfirm: 'Quit to menu? You can continue from the start of this stage.',
    stages: ['Quiet Crater', 'Starlight Canyon', 'Ice Cave', 'Zero-Gravity Zone', "Moon Rabbit King's Palace", 'Yellow Cloud Sea', 'Acid Rain Canyon', 'Lava Plains', 'Lightning Storm Zone', "Gwiyomi's Hideout", 'Red Desert', 'Canyon Zone', 'Sandstorm Region', 'Robot Base', 'Toy Fortress'],
    stageLbl: 'STAGE', gameOver: 'GAME OVER', stageClear: 'STAGE CLEAR!', timeBonus: 'Time bonus',
    worldClear: '👑 Gwiyomi is back to his old self! The family is together again!', newRecord: '🎉 New personal best!',
    finalScore: 'Score', reachedStage: 'Reached', resTitle: '🍋 Result',
    oneUp: '1UP!', mounted: '👨 Dad gives you a piggyback!', bossWarn: '⚡ The Moon Rabbit King appears!', bossWarn2: '⚡ Gwiyomi appears!', bossWarn3: '⚡ Gwiyomi arrives with his toy blasters!',
    ...
    chars: { uja: 'Ppanggeul', uni: 'Dad', yeomra: 'Moon Rabbit King', jjo: 'Gwiyomi' },
    story: {
      intro: ["In a small town, Ppanggeul was worried sick — her little brother Gwiyomi had vanished while chasing a shooting star.", "Wait for me, Gwiyomi! Your big sister will find you! Dad, will you come with me?", "And so Ppanggeul and her dad set off on a space journey to the Moon."],
      after5: ["A child from Earth, all the way out here? ...Your courage impresses me.", "I saw your brother heading toward that glittering planet, Venus. But... something about his eyes looked strange.", "Strange? Ppanggeul hurried off toward Venus."],
      before10: ["There he is! Gwiyomi!!", "...Who are you? Go away!!", "What's wrong with Gwiyomi? He doesn't seem to recognize me at all."],
      after10: ["Still not himself, Gwiyomi fled toward Mars without ever recognizing his sister.", "Let's follow him to Mars. We'll bring him back for sure!"],
      ending: ["As the toys shattered... a strange light faded from Gwiyomi's eyes.", "...Sis? What... what was I even doing?", "Gwiyomi!! I'm so glad — it's really okay now!!", "Hand in hand, the three of them returned together to the warm Earth. — The End —"],
    },
  },
  ko: {
    sub: '우주 대모험', start: '▶ 게임 시작', cont: '▶ 이어하기', records: '🏆 기록실',
    back: '← 뒤로', retry: '🔄 다시 도전', menu: '메뉴로', nickPh: '닉네임',
    help: '<b>←→</b> 이동 · <b>Space/↑</b> 점프(길게 = 높이) · <b>Shift</b> 달리기<br>외계생명체는 밟아서 물리치세요 · <b>아빠</b>한테 업히면 2단 점프!<br>☄️ 별똥고추 = <b>Shift</b> 탭으로 불꽃 발사 · 🐰 토끼 부적 = 공중에서 점프 길게 눌러 활강<br><b>ESC</b> 일시정지 · 📱 모바일 터치 지원',
    credit: 'AI로 100% 제작한 인디게임 · 2026년 7월 · ',
    expSave: '💾 세이브 내보내기', impSave: '📂 세이브 불러오기',
    impConfirm: '이 세이브 파일로 현재 기록을 덮어쓸까요?',
    impErr: '올바른 빵글이의 모험 세이브 파일이 아닙니다', expDone: '세이브 파일이 다운로드되었습니다',
    recNote: '기록은 이 브라우저에 저장됩니다. 다른 컴퓨터로 옮기려면 세이브를 내보내세요.',
    colRank: '순위', colName: '닉네임', colScore: '점수', colStage: '스테이지', colDate: '날짜',
    emptyRec: '아직 기록이 없습니다 — 귀요미를 찾으러 가요!',
    pauseT: '⏸ 일시정지', resume: '▶ 계속하기', quit: '🏳 그만하기',
    quitConfirm: '메뉴로 나갈까요? 이 스테이지 시작부터 이어할 수 있습니다.',
    stages: ['고요한 크레이터', '별빛 협곡', '얼음 동굴', '무중력 지대', '토끼왕의 궁전', '노란 구름바다', '산성비 협곡', '용암 평원', '번개 폭풍지대', '귀요미의 은신처', '붉은 사막', '협곡 지대', '모래폭풍 지역', '로봇 기지', '장난감 요새'],
    stageLbl: '스테이지', gameOver: '게임 오버', stageClear: '스테이지 클리어!', timeBonus: '시간 보너스',
    worldClear: '👑 귀요미가 예전 모습으로 돌아왔어요! 우리 가족이 다시 하나가 되었어요!', newRecord: '🎉 개인 최고기록 갱신!',
    finalScore: '점수', reachedStage: '도달', resTitle: '🍋 결과',
    oneUp: '생명 +1!', mounted: '👨 아빠가 업어줘요!', bossWarn: '⚡ 달나라 토끼왕 등장!', bossWarn2: '⚡ 귀요미가 나타났다!', bossWarn3: '⚡ 장난감을 든 귀요미 등장!',
    ...
    chars: { uja: '빵글이', uni: '아빠', yeomra: '달나라 토끼왕', jjo: '귀요미' },
    story: {
      intro: ['작은 마을에 사는 빵글이는 동생 귀요미가 별똥별을 쫓아가다 사라져버린 게 너무 걱정됐어요.', '기다려, 귀요미! 누나가 꼭 찾아줄게! 아빠, 저랑 같이 가주실 거죠?', '그렇게 빵글이와 아빠는 달나라로 향하는 우주 여행을 떠났습니다.'],
      after5: ['이승… 아니, 지구의 아이가 여기까지 오다니. 그 용기, 인정하마.', '네 동생은 저 반짝이는 금성 쪽으로 가는 걸 봤다. 한데… 그 아이, 눈빛이 좀 이상해 보이더구나.', '이상하다니? 빵글이는 서둘러 금성으로 향했습니다.'],
      before10: ['저기 있다! 귀요미야!!', '……누구세요? 저리 가세요!!', '귀요미가… 왜 저래? 나를 못 알아보는 것 같아.'],
      after10: ['정신이 이상해진 귀요미는 끝내 누나를 알아보지 못하고 화성 쪽으로 도망쳤습니다.', '화성까지 쫓아가자. 거기서 반드시 데려오자!'],
      ending: ['장난감이 부서지고… 귀요미의 눈에서 이상한 빛이 걷혔습니다.', '……누나? 나 지금까지 뭐 한 거야?', '귀요미야!! 정말 다행이야, 이제 괜찮아!!', '셋은 손을 잡고, 따뜻한 지구로 함께 돌아갔답니다. — 끝 —'],
    },
  },
  ja: {
    sub: '宇宙大冒険', start: '▶ ゲーム開始', cont: '▶ つづきから', records: '🏆 記録室',
    back: '← 戻る', retry: '🔄 もう一度', menu: 'メニューへ', nickPh: 'ニックネーム',
    help: '<b>←→</b> 移動 · <b>Space/↑</b> ジャンプ(長押し=高く) · <b>Shift</b> ダッシュ<br>エイリアンは踏んで倒そう · <b>パパ</b>におんぶしてもらうと2段ジャンプ！<br>☄️ 彗星唐辛子 = <b>Shift</b>で火の玉発射 · 🐰 うさぎのお守り = 空中でジャンプ長押しで滑空<br><b>ESC</b> 一時停止 · 📱 モバイルタッチ対応',
    credit: 'AIだけで作られたインディーゲーム · 2026年7月 · ',
    expSave: '💾 セーブを書き出す', impSave: '📂 セーブを読み込む',
    impConfirm: 'このセーブファイルで現在の記録を上書きしますか？',
    impErr: '正しいパングリの冒険のセーブファイルではありません', expDone: 'セーブファイルをダウンロードしました',
    recNote: '記録はこのブラウザに保存されます。別のパソコンへはセーブの書き出しで移行できます。',
    colRank: '順位', colName: '名前', colScore: 'スコア', colStage: 'ステージ', colDate: '日付',
    emptyRec: 'まだ記録がありません — グィヨミを探しに行こう！',
    pauseT: '⏸ 一時停止', resume: '▶ つづける', quit: '🏳 やめる',
    quitConfirm: 'メニューに戻りますか？このステージの最初から再開できます。',
    stages: ['静かなクレーター', '星明かりの峡谷', '氷の洞窟', '無重力地帯', 'ウサギ王の宮殿', '黄色い雲の海', '酸性雨の峡谷', '溶岩平原', '雷嵐地帯', 'グィヨミの隠れ家', '赤い砂漠', '峡谷地帯', '砂嵐地域', 'ロボット基地', 'おもちゃ要塞'],
    stageLbl: 'ステージ', gameOver: 'ゲームオーバー', stageClear: 'ステージクリア！', timeBonus: 'タイムボーナス',
    worldClear: '👑 グィヨミが元通りになりました！家族がまたひとつになりました！', newRecord: '🎉 自己ベスト更新！',
    finalScore: 'スコア', reachedStage: '到達', resTitle: '🍋 リザルト',
    oneUp: '残機 +1！', mounted: '👨 パパがおんぶしてくれる！', bossWarn: '⚡ 月ウサギ王あらわる！', bossWarn2: '⚡ グィヨミが現れた！', bossWarn3: '⚡ おもちゃを持ったグィヨミ登場！',
    ...
    chars: { uja: 'パングリ', uni: 'パパ', yeomra: '月ウサギ王', jjo: 'グィヨミ' },
    story: {
      intro: ['小さな町に住むパングリは、流れ星を追いかけて消えてしまった弟のグィヨミのことがとても心配でした。', '待ってて、グィヨミ！お姉ちゃんが必ず見つけてあげる！パパ、一緒に来てくれる？', 'こうしてパングリとパパは、月へ向かう宇宙の旅に出発しました。'],
      after5: ['地球の子供がここまで来るとは…その勇気、認めよう。', 'お前の弟なら、あのキラキラ光る金星の方へ向かうのを見たぞ。だが…あの子の目、少し様子がおかしかった。', 'おかしいって…？パングリは急いで金星へと向かいました。'],
      before10: ['いた！グィヨミ！！', '……誰？あっちに行って！！', 'グィヨミ、どうしちゃったの？私のことが全然わからないみたい。'],
      after10: ['様子のおかしいグィヨミは、姉に気づくことのないまま火星へと逃げていきました。', '火星まで追いかけよう。今度こそ必ず連れ帰るんだ！'],
      ending: ['おもちゃが砕け散ると…グィヨミの瞳から不思議な光が消えていきました。', '……お姉ちゃん？僕、今まで何をしてたんだろう……', 'グィヨミ!! 本当によかった、もう大丈夫だよ!!', '三人は手を取り合い、温かい地球へと一緒に帰っていきました。― おしまい ―'],
    },
  },
  es: {
    sub: 'AVENTURA ESPACIAL', start: '▶ Empezar', cont: '▶ Continuar', records: '🏆 Récords',
    back: '← Atrás', retry: '🔄 Jugar otra vez', menu: 'Menú', nickPh: 'Apodo',
    help: '<b>←→</b> Moverse · <b>Espacio/↑</b> Saltar (mantén = más alto) · <b>Shift</b> Correr<br>Pisa a los alienígenas para vencerlos · ¡súbete a hombros de <b>Papá</b> para un doble salto!<br>☄️ Chile cometa = pulsa <b>Shift</b> para lanzar bolas de fuego · 🐰 Amuleto de conejo = mantén salto para planear<br><b>ESC</b> Pausa · 📱 controles táctiles en móvil',
    ...
    impErr: 'No es un archivo de guardado válido de LA AVENTURA DE PPANGGEUL', expDone: 'Partida descargada',
    ...
    emptyRec: 'Aún no hay récords — ¡ve a buscar a Gwiyomi!',
    pauseT: '⏸ Pausa', resume: '▶ Continuar', quit: '🏳 Salir',
    quitConfirm: '¿Salir al menú? Podrás continuar desde el inicio de esta fase.',
    stages: ['Cráter Silencioso', 'Cañón Estelar', 'Cueva de Hielo', 'Zona de Gravedad Cero', 'Palacio del Rey Conejo Lunar', 'Mar de Nubes Amarillas', 'Cañón de Lluvia Ácida', 'Llanuras de Lava', 'Zona de Tormentas Eléctricas', 'El Escondite de Gwiyomi', 'Desierto Rojo', 'Zona de Cañones', 'Región de Tormentas de Arena', 'Base Robot', 'Fortaleza de Juguetes'],
    stageLbl: 'FASE', gameOver: 'FIN DEL JUEGO', stageClear: '¡FASE SUPERADA!', timeBonus: 'Bono de tiempo',
    worldClear: '👑 ¡Gwiyomi ha vuelto a ser el de antes! ¡La familia está unida de nuevo!', newRecord: '🎉 ¡Nueva mejor marca!',
    finalScore: 'Puntuación', reachedStage: 'Alcanzado', resTitle: '🍋 Resultado',
    oneUp: '¡Vida extra!', mounted: '👨 ¡Papá te lleva a caballito!', bossWarn: '⚡ ¡Aparece el Rey Conejo Lunar!', bossWarn2: '⚡ ¡Aparece Gwiyomi!', bossWarn3: '⚡ ¡Gwiyomi llega con sus juguetes lanzadores!',
    ...
    chars: { uja: 'Ppanggeul', uni: 'Papá', yeomra: 'Rey Conejo Lunar', jjo: 'Gwiyomi' },
    story: {
      intro: ['En un pequeño pueblo, Ppanggeul estaba muy preocupada: su hermanito Gwiyomi había desaparecido persiguiendo una estrella fugaz.', '¡Espérame, Gwiyomi! ¡Tu hermana mayor te encontrará! Papá, ¿vienes conmigo?', 'Y así, Ppanggeul y su papá partieron en un viaje espacial hacia la Luna.'],
      after5: ['¿Una niña de la Tierra, hasta aquí? ...Tu valentía me impresiona.', 'Vi a tu hermano dirigirse hacia ese planeta brillante, Venus. Pero... algo en su mirada se veía extraño.', '¿Extraño? Ppanggeul se apresuró hacia Venus.'],
      before10: ['¡Ahí está! ¡¡Gwiyomi!!', '...¿Quién eres? ¡¡Vete!!', '¿Qué le pasa a Gwiyomi? Parece que no me reconoce en absoluto.'],
      after10: ['Sin recuperar el sentido, Gwiyomi huyó hacia Marte sin reconocer jamás a su hermana.', 'Sigámoslo hasta Marte. ¡Esta vez lo traeremos de vuelta seguro!'],
      ending: ['Cuando los juguetes se hicieron pedazos... una luz extraña se desvaneció de los ojos de Gwiyomi.', '...¿Hermana? ¿Qué... qué estaba haciendo?', '¡¡Gwiyomi!! Qué alivio, ¡¡ya todo está bien!!', 'Tomados de la mano, los tres regresaron juntos a la cálida Tierra. — Fin —'],
    },
  },
  zh: {
    sub: '太空大冒险', start: '▶ 开始游戏', cont: '▶ 继续游戏', records: '🏆 记录室',
    back: '← 返回', retry: '🔄 再来一次', menu: '菜单', nickPh: '昵称',
    help: '<b>←→</b> 移动 · <b>空格/↑</b> 跳跃(长按=更高) · <b>Shift</b> 奔跑<br>踩到外星怪就能打倒它们 · 让<b>爸爸</b>背着走可以二段跳！<br>☄️ 彗星辣椒 = 按<b>Shift</b>发射火球 · 🐰 兔子护身符 = 空中长按跳跃滑翔<br><b>ESC</b> 暂停 · 📱 移动端触控支持',
    credit: '100% 由 AI 制作的独立游戏 · 2026年7月 · ',
    expSave: '💾 导出存档', impSave: '📂 导入存档',
    impConfirm: '用此存档覆盖当前记录？',
    impErr: '不是有效的胖圆儿大冒险存档文件', expDone: '存档已下载',
    recNote: '记录保存在此浏览器中。导出存档即可迁移到其他电脑。',
    colRank: '#', colName: '昵称', colScore: '分数', colStage: '关卡', colDate: '日期',
    emptyRec: '还没有记录——快去寻找归尤米吧！',
    pauseT: '⏸ 暂停', resume: '▶ 继续', quit: '🏳 退出',
    quitConfirm: '返回菜单？可以从本关开头继续。',
    stages: ['寂静陨石坑', '星光峡谷', '冰洞', '零重力地带', '兔子王宫殿', '黄色云海', '酸雨峡谷', '熔岩平原', '雷暴地带', '归尤米的藏身处', '红色沙漠', '峡谷地带', '沙尘暴区域', '机器人基地', '玩具要塞'],
    stageLbl: '关卡', gameOver: '游戏结束', stageClear: '过关！', timeBonus: '时间奖励',
    worldClear: '👑 归尤米恢复了原来的样子！一家人重新团聚了！', newRecord: '🎉 刷新个人最佳！',
    finalScore: '分数', reachedStage: '到达', resTitle: '🍋 结算',
    oneUp: '生命 +1！', mounted: '👨 爸爸背着你走！', bossWarn: '⚡ 月兔王出现！', bossWarn2: '⚡ 归尤米出现了！', bossWarn3: '⚡ 手持玩具的归尤米登场！',
    ...
    chars: { uja: 'Ppanggeul', uni: '爸爸', yeomra: '月兔王', jjo: 'Gwiyomi' },
    story: {
      intro: ['住在小镇上的胖圆儿(Ppanggeul)非常担心——弟弟归尤米(Gwiyomi)追着一颗流星跑丢了。', '等着我，归尤米！姐姐一定会找到你的！爸爸，你能陪我一起去吗？', '就这样，胖圆儿和爸爸踏上了前往月球的太空之旅。'],
      after5: ['地球来的孩子，竟然能到这里……你的勇气，我很欣赏。', '我看见你弟弟往那颗闪闪发光的金星去了。不过……那孩子的眼神，看起来有点不对劲。', '不对劲？胖圆儿匆匆赶往金星。'],
      before10: ['在那里！归尤米！！', '……你是谁？走开！！', '归尤米怎么了？他好像完全认不出我了。'],
      after10: ['神志不清的归尤米始终没有认出姐姐，径直逃向了火星。', '追到火星去吧。这次一定要把他带回来！'],
      ending: ['玩具碎裂的瞬间……归尤米眼中那道奇怪的光消失了。', '……姐姐？我……我刚才在做什么？', '归尤米！！太好了，真的没事了！！', '三人手牵着手，一起回到了温暖的地球。——完——'],
    },
  },
};
...
/* 대포알 (탱크 포탄, 도화선 불꽃) */
function drawShell(x, w, h) { // 귀요미가 던지는 장난감 공
  x.save(); x.translate(w / 2, h / 2); x.rotate(h * 0.02);
  const g = x.createRadialGradient(-2, -2, 1, 0, 0, w / 2);
  g.addColorStop(0, '#ff9ec0'); g.addColorStop(1, '#e0507c');
  x.fillStyle = g;
  x.beginPath(); x.arc(0, 0, w / 2 - 1, 0, 6.283); x.fill();
  x.strokeStyle = '#fff'; x.lineWidth = 1.6;
  x.beginPath(); x.arc(0, 0, w / 2 - 3, 0.3, 1.5); x.stroke();
  x.beginPath(); x.arc(0, 0, w / 2 - 3, Math.PI + 0.3, Math.PI + 1.5); x.stroke();
  x.fillStyle = 'rgba(255,255,255,.5)';
  x.beginPath(); x.arc(-2.4, -2.4, 1.8, 0, 6.283); x.fill();
  x.restore();
}
...
/* 부적 (보스 투사체) */
function drawTalisman(x, w, h) { // 토끼왕의 떡 (rice cake)
  x.save(); x.translate(w / 2, h / 2); x.rotate(0.15);
  const g = x.createRadialGradient(-2, -3, 1, 0, 0, 8);
  g.addColorStop(0, '#fffaf0'); g.addColorStop(1, '#f0e0c8');
  x.fillStyle = g;
  x.beginPath(); x.ellipse(0, 0, 8, 6.4, 0, 0, 6.283); x.fill();
  x.fillStyle = 'rgba(255,255,255,.6)';
  x.beginPath(); x.ellipse(-2.6, -1.8, 2.6, 1.8, 0, 0, 6.283); x.fill();
  x.fillStyle = '#e0a8b8';
  x.beginPath(); x.arc(1.5, 0.5, 1.1, 0, 6.283); x.fill();
  x.restore();
}
/* 아이템 */
...
function drawTileMars(x) { // 화성 붉은 모래
  x.fillStyle = '#a8502c'; x.fillRect(0, 0, 32, 32);
  x.fillStyle = '#8e3e20';
  x.fillRect(4, 12, 6, 5); x.fillRect(18, 20, 7, 5); x.fillRect(10, 25, 5, 4); x.fillRect(22, 8, 5, 4);
  x.fillStyle = '#c86a3c'; x.fillRect(0, 0, 32, 7);
  x.fillStyle = '#e08858';
  for (let i = 0; i < 6; i++) { x.beginPath(); x.arc(3 + i * 5.4, 6.4, 3, Math.PI, 0); x.fill(); }
  x.fillStyle = 'rgba(60,20,10,.35)';
  x.beginPath(); x.arc(8, 18, 0.9, 0, 6.283); x.arc(16, 12, 0.9, 0, 6.283); x.arc(27, 24, 0.9, 0, 6.283); x.fill();
}
...
function buildSprites() {
  ...
  SPR.ground = {
    ...
    lava: mk(32, 32, drawTileLava), steel: mk(32, 32, drawTileSteel), mars: mk(32, 32, drawTileMars),
  };
  SPR.tile = {
...
/* ============================================================
   ...
   ============================================================ */
const THEMES = [
  // ===== World 1: 달나라 (Moon), stages 1-5 =====
  { sky: ['#0a1428', '#1c3050'], hill: '#3a4560', hill2: '#242c42', deco: 'crater', light: 0.65, moon: 1, ground: 'snow', amb: 'sparkle' },
  { sky: ['#0e1a30', '#20385c'], hill: '#424e6c', hill2: '#2a324a', deco: 'crater', light: 0.6, moon: 1, ground: 'snow', amb: 'sparkle' },
  { sky: ['#080e20', '#141c38'], hill: '#2c3450', hill2: '#181e34', deco: 'crater', light: 0.5, ground: 'snow', amb: 'snow' },
  { sky: ['#0a1020', '#182440'], hill: '#303a58', hill2: '#1c2440', deco: 'crater', light: 0.55, moon: 1, ground: 'steel', amb: 'sparkle' },
  { sky: ['#2c1840', '#4c2860'], hill: '#3c2050', hill2: '#241030', deco: 'fortress', light: 0.62, ground: 'snow', amb: 'sparkle' },
  // ===== World 2: 금성 (Venus), stages 6-10 =====
  { sky: ['#a87a2c', '#e8c860'], hill: '#6a4a20', hill2: '#4a3216', deco: 'volcano', light: 0.85, ground: 'lava', amb: 'ember', lava: 1 },
  { sky: ['#8a6020', '#c8a040'], hill: '#5c3e18', hill2: '#3e2a10', deco: 'volcano', light: 0.8, ground: 'lava', amb: 'ember', lava: 1 },
  { sky: ['#703010', '#a85018'], hill: '#4a2010', hill2: '#2e140a', deco: 'volcano', light: 0.75, ground: 'lava', amb: 'ember', lava: 1 },
  { sky: ['#605888', '#948cc0'], hill: '#3c3860', hill2: '#242040', deco: 'volcano', light: 0.7, ground: 'lava', amb: 'wind', lava: 1 },
  { sky: ['#3c1050', '#601c70'], hill: '#4a2060', hill2: '#2c1040', deco: 'fortress', light: 0.68, ground: 'lava', amb: 'ember', lava: 1 },
  // ===== World 3: 화성 (Mars), stages 11-15 =====
  { sky: ['#c85838', '#f0a068'], hill: '#8a3a24', hill2: '#5c2414', deco: 'marsrock', light: 0.9, ground: 'mars', amb: 'wind' },
  { sky: ['#b04a2c', '#e08858'], hill: '#7a3220', hill2: '#4e2010', deco: 'marsrock', light: 0.85, ground: 'mars', amb: 'wind' },
  { sky: ['#8a3620', '#c06840'], hill: '#602814', hill2: '#3a180c', deco: 'marsrock', light: 0.75, ground: 'mars', amb: 'wind' },
  { sky: ['#503028', '#805040'], hill: '#3c2820', hill2: '#241812', deco: 'marsrock', light: 0.68, ground: 'steel', amb: 'wind' },
  { sky: ['#2c1418', '#4c2020'], hill: '#3a1c1c', hill2: '#241010', deco: 'fortress', light: 0.65, ground: 'steel', amb: 'gold' },
];
...
function updateEnts(dt) {
  ...
  for (const e of ents) {
    ...
    switch (e.type) {
      ...
      case 'shout': { // 귀요미의 소리지르기 (확장하는 충격파 링)
        e.t += dt;
        const r = e.r0 + e.spd * e.t;
        e.x = e.cx - r; e.y = e.cy - r; e.w = r * 2; e.h = r * 2;
    ...
    // 플레이어 상호작용 (적 계열)
    if (!e.dead && !p.dead && ['ghost', 'reaper', 'dok', 'egg', 'fox', 'hat', 'tal', 'boss', 'jjojjo', 'jjotank', 'blt', 'shell', 'shout'].includes(e.type)) {
      if (!overlap(e, p)) continue;
      if (e.type === 'hat' && e.t < 0.3) continue;
      if (e.type === 'shout' && e.hitDone) continue;
      const isBoss = e.type === 'boss' || e.type === 'jjojjo' || e.type === 'jjotank';
      const proj = e.type === 'tal' || e.type === 'blt' || e.type === 'shell' || e.type === 'shout';
      ...
      if (stomp) {
        ...
        if (e.type === 'shout') e.hitDone = true;
      }
    }
  }
...
function updateJjojjo(e, dt) {
  ...
  if (e.shoutN > 0) {
    ...
    e.shotT -= dt;
    if (e.shotT <= 0) {
      e.shotT = 0.35; e.shoutN--;
      ents.push({ type: 'shout', cx: e.x + e.w / 2, cy: e.y + e.h * 0.5, r0: 10, spd: 260, t: 0, life: 0.55, x: 0, y: 0, w: 0, h: 0 });
      e.flash = 0.15;
      sfx.shot();
    }
  } else {
    // 접근 (체력 줄수록 빠르고 소리지르기 간격 단축)
    const speed = 40 + (e.maxHp - e.hp) * 14;
    e.vx = e.dir * speed;
    e.burstT -= dt;
    if (e.burstT <= 0) {
      e.burstT = Math.max(1.6, 3.0 - (e.maxHp - e.hp) * 0.22);
      e.shoutN = 2; // 연속 두 번 소리지르기
      e.shotT = 0.3;
      sfx.throwP();
    }
  }
...
function updateJjotank(e, dt) {
  ...
  if (e.shoutN > 0) {
    ...
    e.shotT -= dt;
    if (e.shotT <= 0) {
      e.shotT = 0.3; e.shoutN--;
      ents.push({ type: 'shout', cx: e.x + e.w / 2, cy: e.y + e.h * 0.5, r0: 10, spd: 280, t: 0, life: 0.55, x: 0, y: 0, w: 0, h: 0 });
      e.flash = 0.15; sfx.shot();
    }
  } else {
    // 전진 (체력 줄수록 빠름)
    ...
    if (e.throwT <= 0) {
      ...
      if (hpLost >= 3 && Math.random() < 0.42) {
        // 소리지르기 버스트
        e.shoutN = 3 + Math.min(3, hpLost); e.shotT = 0.3; sfx.throwP();
      } else {
        // 양손 장난감 던지기 (좌우 손에서 하나씩, 플레이어 거리 겨냥)
        const dx = p.x - e.x, dist = Math.abs(dx);
        const baseVx = Math.sign(dx) * Math.min(300, 90 + dist * 0.55);
        ents.push({ type: 'shell', x: e.x + e.w / 2 - 16, y: e.y + 6, w: 18, h: 20, vx: baseVx - 30, vy: -360, dir: e.dir, t: 0 });
        ents.push({ type: 'shell', x: e.x + e.w / 2 + 16, y: e.y + 6, w: 18, h: 20, vx: baseVx + 30, vy: -340, dir: e.dir, t: 0 });
...
function drawBG(th, vw, t) {
  ...
  for (let k = Math.floor(off / step) - 1; k < (off + vw) / step + 1; k++) {
    ...
    } else if (th.deco === 'crater') { // 달 크레이터 + 작은 깃발
      cx.fillStyle = '#4a5270';
      cx.beginPath(); cx.ellipse(bx + 30, by + 44, 34, 14, 0, 0, Math.PI, true); cx.fill();
      cx.fillStyle = '#5e6890';
      cx.beginPath(); cx.ellipse(bx + 30, by + 40, 24, 9, 0, 0, Math.PI, true); cx.fill();
      if (k % 2 === 0) {
        cx.strokeStyle = '#cfd6ea'; cx.lineWidth = 2;
        cx.beginPath(); cx.moveTo(bx + 30, by + 30); cx.lineTo(bx + 30, by + 6); cx.stroke();
        cx.fillStyle = '#ff6a6a';
        cx.beginPath(); cx.moveTo(bx + 30, by + 6); cx.lineTo(bx + 44, by + 11); cx.lineTo(bx + 30, by + 16); cx.closePath(); cx.fill();
      }
    } else if (th.deco === 'marsrock') { // 화성 암석 첨탑
      cx.fillStyle = '#6a2c1c';
      cx.beginPath();
      cx.moveTo(bx - 4, by + 56); cx.lineTo(bx + 10, by + 4); cx.lineTo(bx + 22, by + 30);
      cx.lineTo(bx + 34, by - 10); cx.lineTo(bx + 48, by + 40); cx.lineTo(bx + 60, by + 56);
      cx.closePath(); cx.fill();
      cx.fillStyle = '#8a4028';
      cx.beginPath(); cx.moveTo(bx + 30, by - 6); cx.lineTo(bx + 34, by - 10); cx.lineTo(bx + 38, by - 2); cx.lineTo(bx + 32, by + 4); cx.closePath(); cx.fill();
    }
  }
  // 구름 (밝은 테마)
  if (th.light >= 0.9) {
...
function render(nowS) {
  ...
  for (const e of ents) {
    ...
    switch (e.type) {
      ...
      case 'shout': { // 귀요미의 소리지르기 충격파
        const prog = Math.min(1, e.t / e.life);
        const cxp = ex + e.w / 2, cyp = e.y + e.h / 2, rr2 = e.w / 2;
        cx.strokeStyle = `rgba(255,120,180,${0.55 * (1 - prog)})`;
        cx.lineWidth = 3.5 * (1 - prog * 0.6);
        cx.beginPath(); cx.arc(cxp, cyp, rr2, 0, 6.283); cx.stroke();
        cx.strokeStyle = `rgba(255,220,120,${0.35 * (1 - prog)})`;
        cx.lineWidth = 1.6;
        cx.beginPath(); cx.arc(cxp, cyp, Math.max(0, rr2 - 6), 0, 6.283); cx.stroke();
        break;
      }
      case 'boss': {
...
function runSim() {
  ...
  LV.bossArena = { x0: 2 * TILE, x1: 78 * TILE, entered: true };
  LV.goalActive = false;
  const jjo = { type: 'jjojjo', x: 40 * TILE, y: (ROWS - 2) * TILE - 58, w: 44, h: 58, vx: 0, vy: 0, dir: -1, hp: 6, maxHp: 6, burstT: 0.05, shoutN: 0, shotT: 0, flash: 0, stun: 0, inv: 0, dead: false };
  ents = [jjo];
  player = mkPlayer(10 * TILE, (ROWS - 4) * TILE);
  player.inv = 99; // 충격파 피해 무시하고 발사만 검증
  let jjoShouted = false;
  for (let i = 0; i < 200 && !jjoShouted; i++) { update(1 / 60); if (ents.some(e => e.type === 'shout')) jjoShouted = true; }
  T('gwiyomi shouts (shockwave)', jjoShouted, `shouted=${jjoShouted}`);
  ...
  LV.goalActive = false;
  G.introT = 0;
  const tank = { type: 'jjotank', x: 46 * TILE, y: (ROWS - 2) * TILE - 74, w: 92, h: 74, vx: 0, vy: 0, dir: -1, hp: 8, maxHp: 8, throwT: 0.05, shoutN: 0, shotT: 0, flash: 0, stun: 0, inv: 0, dead: false };
  ents = [tank];
  player = mkPlayer(12 * TILE, (ROWS - 4) * TILE);
  player.inv = 999;
  let tankFired = false;
  for (let i = 0; i < 200 && !tankFired; i++) { update(1 / 60); if (ents.some(e => e.type === 'shell' || e.type === 'shout')) tankFired = true; }
  T('jjotank throws toys / shouts', tankFired, `fired=${tankFired}`);
