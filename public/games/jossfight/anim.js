...
var ANIM = {
  ...
  /* ★새 동작 셋 (2026-08-21) — 필살기가 열 명 모두 '장풍·대공·돌진' 세 모양이면
     기술 이름만 다르고 **눈에는 같은 게임**이다. 실루엣이 다른 동작을 셋 더 둔다. */
  stomp: [  // 내려찍기 24F · 타격 f10 — 두 팔을 머리 위로 들었다가 몸무게째 떨군다
    { t: 4, e: 'out',  p: pose(STAND, { y: -4, torso: P - 0.04, xA: 0.94,
                                        aU: [2.10, 2.30], aF: [2.45, 2.60], lU: [-0.50, 0.50], lS: [0.50, -0.22] }) },
    { t: 5, e: 'out3', p: pose(STAND, { y: -13, torso: P + 0.04, xA: 0.88,        // 최고점 — 잠깐 멈춘다
                                        aU: [2.58, 2.78], aF: [2.80, 2.94], lU: [-0.56, 0.56], lS: [0.60, -0.26] }) },
    { t: 3, e: 'lin',  p: pose(STAND, { y: 20, torso: P - 0.58, xA: 1.24,         // ← 내려찍음
                                        aU: [0.40, 0.50], aF: [0.14, 0.20], lU: [-0.82, 0.88], lS: [0.92, -0.62] }) },
    { t: 5, e: 'out',  p: pose(STAND, { y: 15, torso: P - 0.46, xA: 1.10,
                                        aU: [0.52, 0.64], aF: [0.36, 0.46], lU: [-0.74, 0.80], lS: [0.86, -0.54] }) },
    { t: 7, e: 'back', p: pose(STAND) },
  ],
  roll: [   // 구르기 22F — 몸을 공처럼 말아 굴러 빠져나간다(회피기)
    { t: 3, e: 'in',   p: pose(STAND, { y: 16, torso: P - 0.60, xA: 0.92,
                                        aU: [-0.30, 0.40], aF: [0.20, 0.90], lU: [-0.70, 0.90], lS: [1.00, -0.70] }) },
    { t: 4, e: 'lin',  p: pose(STAND, { y: 30, torso: P - 1.50, head: -0.50, xA: 0.86,
                                        aU: [-1.20, -0.90], aF: [-1.40, -1.10], lU: [1.40, 1.50], lS: [1.50, 1.40] }) },
    { t: 4, e: 'lin',  p: pose(STAND, { y: 26, torso: P - 2.55, head: -0.80, xA: 0.86,
                                        aU: [-2.00, -1.70], aF: [-2.20, -1.90], lU: [2.00, 2.10], lS: [1.90, 1.80] }) },
    { t: 4, e: 'out',  p: pose(STAND, { y: 14, torso: P - 0.50, xA: 0.96,
                                        aU: [0.10, 0.60], aF: [0.70, 1.20], lU: [-0.70, 0.80], lS: [0.85, -0.50] }) },
    { t: 7, e: 'back', p: pose(STAND) },
  ],
  toss: [   // 위로 뿌리기 26F · 발사 f9 — 아래에서 당겼다가 머리 위로 던져 올린다
    { t: 4, e: 'in',   p: pose(STAND, { y: 6, torso: P + 0.22, xA: 0.88,
                                        aU: [-0.40, -0.20], aF: [-0.10, 0.15], lU: [-0.60, 0.40], lS: [0.40, -0.05] }) },
    { t: 5, e: 'out3', p: pose(STAND, { y: 2, torso: P + 0.04, xA: 1.00,
                                        aU: [0.60, 1.00], aF: [1.20, 1.60], lU: [-0.56, 0.44], lS: [0.38, -0.08] }) },
    { t: 3, e: 'lin',  p: pose(STAND, { y: -9, torso: P - 0.20, xA: 1.22,         // ← 던져 올림
                                        aU: [2.20, 2.50], aF: [2.60, 2.85], lU: [-0.50, 0.55], lS: [0.40, -0.20] }) },
    { t: 5, e: 'out',  p: pose(STAND, { y: -3, torso: P - 0.12, xA: 1.08,
                                        aU: [1.90, 2.20], aF: [2.30, 2.50], lU: [-0.52, 0.52], lS: [0.36, -0.18] }) },
    { t: 9, e: 'back', p: pose(STAND) },
  ],
