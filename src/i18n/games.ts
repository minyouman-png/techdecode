    ...
    copy: {
      en: {
        ...
        how: [
          ...
          '1–9 or mouse wheel — choose a block · Q — quest log',
      ...
      ko: {
        ...
        about: [
          ...
          '어둠 속에는 7종의 몬스터가 돌아다닙니다. 원거리에서 쏘아대는 NODUCK, 달려들어 후려치는 SEOJB, 무섭게 빠른 KS, 걸어다니는 벽 JW, 몰래 다가와 폭발하는 DS, 튀어오르는 IW, 등 뒤로 순간이동하는 KJ까지. 그리고 사흘 밤마다 전용 체력바를 단 보스 MENEW가 나타납니다. 하트 10개, 자연 회복, 낙하 데미지, 리스폰, 그리고 첫 나무 캐기부터 MENEW 처치까지 도전과제 8종이 준비되어 있습니다.',
      ...
      ja: {
        ...
        about: [
          ...
          '闇には7種類のモンスターが徘徊します。遠くから撃ってくるNODUCK、殴りかかるSEOJB、恐ろしく速いKS、歩く壁のJW、忍び寄って爆発するDS、跳ねまわるIW、背後にテレポートするKJ。そして三日目の夜ごとに、専用HPバーを持つボスMENEWが現れます。ハート10個、自然回復、落下ダメージ、リスポーン、そして最初の原木からMENEW討伐まで8つの実績が待っています。',
      ...
      es: {
        ...
        how: [
          ...
          '1–9 o rueda del ratón — elegir bloque · Q — registro de logros',
      ...
      zh: {
        ...
        about: [
          ...
          '黑暗中游荡着七种怪物：远程狙击的 NODUCK、挥拳冲锋的 SEOJB、快得吓人的 KS、行走的高墙 JW、悄悄靠近然后爆炸的 DS、蹦跳扑来的 IW，还有瞬移到你背后的 KJ。每到第三个夜晚，带专属血条的 Boss MENEW 就会现身。你有十颗心、自然回血、坠落伤害、重生点——还有八个成就等你完成：从砍下第一块原木，到击败 MENEW 本人。',
