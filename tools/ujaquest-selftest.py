#!/usr/bin/env python3
"""유자의 동산 여행(과학·도덕) — `?test=sim` 을 실제 크롬에서 돌리고 결과를 읽는다.

usage: python3 tools/ujaquest-selftest.py --subject science [--shot 3] [--width 900]
...
def main() -> int:
    ...
    proc = subprocess.Popen(
        [CHROME, "--headless=new", f"--remote-debugging-port={args.debug_port}",
         ...
         "--user-data-dir=/tmp/ujaquest-selftest-profile", "about:blank"],
