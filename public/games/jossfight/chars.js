...
var C = [
  /* ---------------------------------------------------------- 1. 민유 — 프로그래머 */
  {
    key: 'minyu', name: '민유', job: '프로그래머', tag: '새벽 세 시의 배포',
  ...
  /* ---------------------------------------------------------- 2. 종범 — 집배원 */
  {
    key: 'jongbeom', name: '종범', job: '집배원', tag: '오늘도 정시 배달',
  ...
  /* ---------------------------------------------------------- 3. 인우 — 컴퓨터 엔지니어 */
  {
    key: 'inwoo', name: '인우', job: '컴퓨터 엔지니어', tag: '재부팅해 보셨어요?',
  ...
  /* ---------------------------------------------------------- 4. 노덕 — 족구선수 */
  {
    key: 'nodeok', name: '노덕', job: '족구 선수', tag: '궁전의 주인',
  ...
  /* ---------------------------------------------------------- 5. 길수 — 축구선수 */
  {
    key: 'gilsu', name: '길수', job: '축구 선수', tag: '왼발의 사람',
  ...
  /* ---------------------------------------------------------- 6. 동식 — 술 좋아하는 아저씨 */
  {
    key: 'dongsik', name: '동식', job: '한 잔 하는 아저씨', tag: '오늘만 마신다',
  ...
  /* ---------------------------------------------------------- 7. 준원 — 안경 쓴 아저씨 */
  {
    key: 'junwon', name: '준원', job: '안경 쓴 아저씨', tag: '내가 왕년에',
  ...
  /* ---------------------------------------------------------- 8. 조스 — 부자 (간판) */
  {
    key: 'joss', name: '조스', job: '부자', tag: '이 게임의 이름값',
  ...
  /* ---------------------------------------------------------- 9. 유진 — 20대 */
  {
    key: 'yujin', name: '유진', job: '20대', tag: '하이힐로도 뛴다',
  ...
  /* ---------------------------------------------------------- 10. 유정 — 여고생 */
  {
    key: 'yujeong', name: '유정', job: '여고생', tag: '가방이 흉기',
